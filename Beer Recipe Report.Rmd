...
max_accuracy_model_nb_upsampling <- model_nb_upsampling$results %>% filter(Accuracy == max(Accuracy))
...
max_accuracy_model_rpart_upsampling <- model_rpart_upsampling$results %>% filter(Accuracy == max(Accuracy))
...
max_accuracy_model_rf_upsampling <- model_rf_upsampling$results %>% filter(Accuracy == max(Accuracy))
...
max_accuracy_model_xgbTree_upsampling <- model_xgbTree_upsampling$results %>% filter(Accuracy == max(Accuracy))
